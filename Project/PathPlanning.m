...
mapData = load("Env3D.mat");
Env_3D = mapData.Env3D;
...
Start=[Start 0.707106781 0 0 0.707106781];
Goal=[Goal 0.707106781 0  0 -0.707106781];
...
if FOUND==1
    ...
    interpolate(path,length(3*path.States-3));
